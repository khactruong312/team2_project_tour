...
<div class="container mt-4">
    ...
    <h2 class="fw-bold mb-3">Chi tiết tài khoản</h2>

    <div class="card shadow-sm detail-box">
        <div class="card-body">
            ...
            <table class="table">
                ...
                <tr>
                    <td class="detail-title">Họ tên:</td>
                    <td><?= $user['fullname'] ?></td>
                </tr>
                <tr>
                    <td class="detail-title">Quyền:</td>
                    <td>
            ...
            <div class="mt-3 d-flex gap-2">
                <a href="index.php?act=user-edit&id=<?= $user['id'] ?>" class="btn btn-warning">Sửa</a>
                <a href="index.php?act=user-list" class="btn btn-secondary">Quay lại</a>
            </div>
