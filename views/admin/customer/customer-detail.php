    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a href="index.php?act=admin-home" class="list-group-item list-group-item-action <?= $current_act == 'admin-home' ? 'active' : '' ?>">
                    <i class="fas fa-tachometer-alt me-2"></i> Dashboard
                </a>
                <a href="index.php?act=tour-list" class="list-group-item list-group-item-action <?= $current_act == 'tour-list' ? 'active' : '' ?>">
                    <i class="fas fa-list me-2"></i> Danh sách tour
                </a>
                <a href="index.php?act=tour-booking" class="list-group-item list-group-item-action <?= $current_act == 'tour-booking' ? 'active' : '' ?>">
                    <i class="fas fa-road me-2"></i> Quản lý Tour
                </a>
                <a href="index.php?act=tour-booking" class="list-group-item list-group-item-action <?= $current_act == 'tour-booking' ? 'active' : '' ?>">
                    <i class="fas fa-road me-2"></i> Quản lý Booking
                </a>
                <a href="index.php?act=customer-list" class="list-group-item list-group-item-action <?= strpos($current_act, 'customer-') === 0 ? 'active' : '' ?>">
